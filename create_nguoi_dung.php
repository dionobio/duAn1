                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="email" class="form-control" placeholder="Nhập email người dùng" name="email">
                                                        <span class="text-danger">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" placeholder="Nhập số điện thoại người dùng" name="so_dien_thoai">
                                                        <span class="text-danger">
